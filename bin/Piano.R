...
GSAsummaryTable(gsaRes_HS_kegg, save=TRUE, file="../results/DESeq2/HS_kegg_DESeq2_piano.xls")
gsaRes_HS_go <- runGSA(HS_stat, fc, gsc=go, geneSetStat="reporter", 
                 signifMethod="nullDist", nPerm=1000, verbose=TRUE)
GSAsummaryTable(gsaRes_HS_go, save=TRUE, file="../results/DESeq2/HS_go_DESeq2_piano.xls")
# gsaRes_HS_onco <- runGSA(HS_stat, fc, gsc=onco, geneSetStat="reporter", 
#                  signifMethod="nullDist", nPerm=1000, verbose=TRUE)
# GSAsummaryTable(gsaRes_HS_onco, save=TRUE, file="../results/DESeq2/HS_onco_DESeq2_piano.xls")

### Steatosis-NASH
print ("HEALTHY-STEATOSIS")
SN_dir <- "../results/DESeq2/SN_DESeq2_genesymb.tsv"
...
gsaRes_SN_kegg <- runGSA(SN_stat, fc, gsc=kegg, geneSetStat="reporter", 
                         signifMethod="nullDist", nPerm=1000, verbose=TRUE)
GSAsummaryTable(gsaRes_SN_kegg, save=TRUE, file="../results/DESeq2/SN_kegg_DESeq2_piano.xls")
gsaRes_SN_go <- runGSA(SN_stat, fc, gsc=go, geneSetStat="reporter", 
                       signifMethod="nullDist", nPerm=1000, verbose=TRUE)
GSAsummaryTable(gsaRes_SN_go, save=TRUE, file="../results/DESeq2/SN_go_DESeq2_piano.xls")
# gsaRes_SN_onco <- runGSA(SN_stat, fc, gsc=onco, geneSetStat="reporter", 
#                          signifMethod="nullDist", nPerm=1000, verbose=TRUE)
# GSAsummaryTable(gsaRes_SN_onco, save=TRUE, file="../results/DESeq2/SN_onco_DESeq2_piano.xls")

### NASH-HCC
print ("HEALTHY-STEATOSIS")
NC_dir <- "../results/DESeq2/NC_DESeq2_genesymb.tsv"
...
gsaRes_NC_kegg <- runGSA(NC_stat, fc, gsc=kegg, geneSetStat="reporter", 
                         signifMethod="nullDist", nPerm=1000, verbose=TRUE)
GSAsummaryTable(gsaRes_NC_kegg, save=TRUE, file="../results/DESeq2/NC_kegg_DESeq2_piano.xls")
gsaRes_NC_go <- runGSA(NC_stat, fc, gsc=go, geneSetStat="reporter", 
                       signifMethod="nullDist", nPerm=1000, verbose=TRUE)
GSAsummaryTable(gsaRes_NC_go, save=TRUE, file="../results/DESeq2/NC_go_DESeq2_piano.xls")
# gsaRes_NC_onco <- runGSA(NC_stat, fc, gsc=onco, geneSetStat="reporter", 
#                          signifMethod="nullDist", nPerm=1000, verbose=TRUE)
# GSAsummaryTable(gsaRes_NC_onco, save=TRUE, file="../results/DESeq2/NC_onco_DESeq2_piano.xls")
