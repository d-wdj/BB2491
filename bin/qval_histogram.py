...
HS = collect_pval("../results/DESeq2/HS_Deseq2_genesymb_FDR5%"+".tsv")
SN = collect_pval("../results/DESeq2/SN_Deseq2_genesymb_FDR5%"+".tsv")
NC = collect_pval("../results/DESeq2/NC_Deseq2_genesymb_FDR5%"+".tsv")
...
plt.savefig("../pictures/deseq2_qval_histogram.png", bbox_inches='tight')
plt.show()
