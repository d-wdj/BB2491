...
limma_dir <- "../results/Limma/Limma_genesymb.tsv"
limma <- read.table(limma_dir, sep='\t', header=TRUE)
N <- nrow(limma)
limma <- limma[1:(N-18500),]
limma <- limma[complete.cases(limma), ]
limma <- limma[!duplicated(limma$gene_symbol), ]
